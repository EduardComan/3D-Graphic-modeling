// Lab2 Hello DirectX 11.cpp : Defines the entry point for the application.
//
...
struct VERTEX { FLOAT X, Y, Z; D3DXCOLOR Color; }; // a struct to define a single vertex
...
void RenderFrame(void)
{
    ...
    devcon->ClearRenderTargetView(backbuffer, D3DXCOLOR{ 1.0f, 0.4f, 0.0f, 1.0f });
    ...
    _In_ int       nCmdShow)
{
    ...
    LoadStringW(hInstance, IDC_LAB2HELLODIRECTX11, szWindowClass, MAX_LOADSTRING);
