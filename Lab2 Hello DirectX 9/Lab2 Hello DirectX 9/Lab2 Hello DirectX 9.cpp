...
void InitD3D(HWND hWnd)
{
 ...
 // create a device class using this information and information from the d3dpp stuct
    ...
    /*CUSTOMVERTEX pTriangleVertices[] =
    {
        ...
        {SCREEN_WIDTH - DELTA_WIDTH, SCREEN_HEIGHT - DELTA_HEIGHT, 1.0f, 1.0f, D3DCOLOR_XRGB(0, 255, 0),},
        {DELTA_WIDTH, SCREEN_HEIGHT - DELTA_HEIGHT, 1.0f, 1.0f, D3DCOLOR_XRGB(255, 0, 0),},
    };*/

    CUSTOMVERTEX pTriangleVertices[] =
    {
        {width / 2.0,  height / 10.0f, 1.0f, 1.0f, D3DCOLOR_XRGB(0, 0, 255),},
        {width - width / 10.0f, height - height / 10.0f, 1.0f, 1.0f, D3DCOLOR_XRGB(0, 255, 0),},
        {width / 10.0f, height - height / 10.0f, 1.0f, 1.0f, D3DCOLOR_XRGB(255, 0, 0),},
    };
...
ATOM MyRegisterClass(HINSTANCE hInstance)
{
    ...
    wcex.hIcon = LoadIcon(hInstance, MAKEINTRESOURCE(IDI_LAB2HELLODIRECTX9));
    wcex.hCursor = LoadCursor(nullptr, IDC_ARROW);
    wcex.hbrBackground = (HBRUSH)(COLOR_WINDOW + 1);
    wcex.lpszMenuName = MAKEINTRESOURCEW(IDC_LAB2HELLODIRECTX9);
